...
export const cooktopsInducaoList: ProductList = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Cooktops 4 bocas embutidos exigem 220V — não tem opção 110V no segmento (a potência total seria muito alta pra 110V). Portáteis 1 boca normalmente são 220V, mas existem exceções importantes: o **Oster Touch Screen 2 em 1** é 127V — uma das poucas opções pra casas que não tem 220V instalado. Em casas só com 110V, instalar 220V exige técnico — investimento de R$ 300-800 dependendo da distância da rua.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "4 bocas se você vai reformar a cozinha e quer cozinha completa por indução (substitui o fogão). Portátil 1-2 bocas se quer testar antes, complementar o fogão existente, ou simplesmente cozinhar de forma mais rápida em alguns dias (chá, café, ovos). Não é \"qualquer um\" — são casos de uso diferentes. O portátil é também ótimo pra quem aluga, não pode reformar, ou usa em chácara/pousada.",
    },
  ],
  products: [
    {
    ...
    },
    {
      ...
      pros: [
        ...
        "Sensor CookSense desliga sem panela",
    ...
    {
      rank: 6,
      name: "Electrolux IE60P Experience Unicook",
      tagline: "Versão compacta da Unicook com 14 níveis e timer",
      description:
      ...
      pros: [
        ...
        "PowerBoost + Turbo Power pra fervura rápida",
        "Painel touch slide-control",
      ],
      cons: [
        "Mesma potência total mas área menor que IE80P",
        "Preço entre o premium IE80P e o mid Tramontina",
      ],
    },
    {
      rank: 7,
      name: "Midea Built In Even Pro 4 Bocas",
      tagline: "Marca global com 8.100W de potência total e função Turbo",
      description:
      ...
      pros: [
        ...
        "9 níveis de potência + timer + trava",
        "Marca global Midea com preço competitivo",
      ],
      cons: [
        "Pós-venda BR menos consolidado que Brastemp/Electrolux",
        "Sem Flexizone ou Unicook",
      ],
    },
    {
      rank: 8,
      name: "Mueller MCI024BG1 Turbo Total",
      tagline: "Entry 4 bocas brasileiro com Turbo em todas as bocas",
      description:
      ...
      pros: [
        ...
        "Função mantém panela aquecida",
        "Faixa entry R$ 1.8-2.5k",
      ],
      cons: [
    ...
    {
      rank: 9,
      name: "Oster Touch Screen 2 em 1 (127V)",
      tagline: "Único portátil 110V da lista — 2 bocas pra casas sem 220V",
      description:
      ...
      pros: [
        ...
        "Touch slide independente nas 2 bocas",
        "Booster + timer até 99 min",
      ],
      cons: [
        "127V limita potência total (menos rápido que 220V)",
        "Só 2 bocas (não substitui cooktop completo)",
      ],
    },
    {
      rank: 10,
      name: "Tramontina Slim Touch 1 Boca (Portátil)",
      tagline: "Portátil 1 boca mais vendido da Tramontina",
      description:
